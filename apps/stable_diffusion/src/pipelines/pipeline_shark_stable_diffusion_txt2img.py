...
class Text2ImagePipeline(StableDiffusionPipeline):
    ...
    # TODO: Move it to a separate ControlNet based specific model functions.
    def hint_canny(self, image: Image.Image, width=512, height=512, low_threshold=100, high_threshold=200):
        with torch.no_grad():
    ...
    def generate_images(
        ...
        controlnet_hint = self.controlnet_hint_conversion(controlnet_hint, height, width, num_images_per_prompt=1)
