...
def upload_img(gr_img, text_input, chat_state, device):
    ...
    if chat is None:
        ...
        vision_model_mlir_path=Path("minigpt4_vision_model_fp32.mlir"),
        vision_model_vmfb_path=Path("minigpt4_vision_model_fp32_cuda.vmfb"),
...
with gr.Blocks() as minigpt4_web:
    ...
    upload_button.click(upload_img, [image, text_input, chat_state, device], [image, text_input, upload_button, chat_state, img_list])
